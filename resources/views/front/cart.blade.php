                        ...
                        <table class="table">
                            ...
                            @php($total=0)
                                ...
                                <tr>
                                    ...
                                    <td class="pro-title"><a href="#">{{$item["product"]->product_name_dch}}</a></td>
                                    ...
                                    <td class="pro-quantity">
                                        <div class="pro-qty"><input type="text" @if($item[ "product" ]->sell_product_option=="weight_wise") value="{{$item["quantity"]>999?$item["quantity"]/1000:$item["quantity"]}}" @else value="{{$item["quantity"]}}" @endif >
                                        </div>
                                        @if($item["product"]->sell_product_option=="weight_wise")
