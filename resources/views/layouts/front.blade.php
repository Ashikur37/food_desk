								...
								<div class="cart-items">
									<div class="cart-float-single-item d-flex">
										...
										<div class="cart-float-single-item-image">
											<a href="single-product.html"><img src="{{URL::to('/')}}/assets/images/products/product01.jpg" class="img-fluid" alt=""></a>
										</div>
									...
									<div class="cart-float-single-item d-flex">
										<span class="remove-item"><a href="#"><i class="fa fa-times"></i></a></span>
										<div class="cart-float-single-item-image">
											<a href="single-product.html"><img src="{{URL::to('/')}}/assets/images/products/product02.jpg" class="img-fluid" alt=""></a>
										</div>
										<div class="cart-float-single-item-desc">
				...
				<div class="row">
					<div class="col-lg-4 col-md-12 col-sm-12 mb-sm-20 mb-xs-20">
						...
						<div class="newsletter-title">
							<h1>
								<img src="{{URL::to('/')}}/assets/images/icon-newsletter.png" alt="">
								Send Newsletter
							</h1>
						</div>
